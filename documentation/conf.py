# -*- coding: utf-8 -*-
#
# biggr_maps documentation build configuration file, created by
...
autoapi_dirs = [join(SRC_PATH, "biggr_maps")]
...
from biggr_maps import __version__ as release  # noqa: E402
